...
class GameCompilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create game_compile" do
    assert_difference("GameCompile.count") do
      post game_compiles_url, params: { game_compile: { game_project_id: @game_compile.game_project_id, platform: @game_compile.platform } }
    end
  ...
  test "should update game_compile" do
    patch game_compile_url(@game_compile), params: { game_compile: { game_project_id: @game_compile.game_project_id, platform: @game_compile.platform } }
